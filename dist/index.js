...
class Keycloak {
    ...
    getGrantFromCode(code, ctx) {
        ...
        const self = this;
        return this.grantManager.obtainFromCode(ctx, code, sessionId).then((grant) => {
            self.storeGrant(grant, ctx);
            return grant;
        });
    }
    ...
    logoutUrl(redirectUrl) {
        return (this.config.realmUrl + '/protocol/openid-connect/logout' + '?redirect_uri=' + encodeURIComponent(redirectUrl));
    }
    accountUrl() {
